...
console.warn(`Sol 15.- La secuencia de Fibonacci hasta el 1000 es: descomentar la funcion para ver el resultado`);
// fibonacciHasta1000();
...
//20.- De tipo warn donde calcules si un nuemro es numero armstrong, tambien conocido como numero narcisista,o numero de repeticion, es un numero que es igual a la suma de sus digitos elevados a la potencia del numero de  digitos. Por ejemplo, 153 es un numero de armstrong por que 1^3 +5^3+3^3=1+125+27=153. 
...
if (suma === numeroArmstrong) {
    console.warn(`Sol 20.- El número ${numeroArmstrong} es un número Armstrong`);
}
